...
symlink('/usr/bin/python', '/opt/python/bin/python3.10')
symlink('/usr/bin/python3', '/opt/python/bin/python3.10')
symlink('/usr/bin/python3-config', '/opt/python/bin/python3.10-config')
