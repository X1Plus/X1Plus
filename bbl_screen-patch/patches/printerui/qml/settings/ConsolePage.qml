        ...
        ScrollView {
            ...
            TextArea {
                ...
                placeholderText: gcodeCmd 
                    ? qsTr("This interface allows you to send G-code commands to the printer. You can enter commands<br>" +
                    ...
                    : qsTr("This interface allows you to run commands on your printer as root. You can enter commands<br>" +
