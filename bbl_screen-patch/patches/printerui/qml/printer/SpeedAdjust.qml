...
Rectangle {
    ...
    function closestLevel(value) { /* find nearest speed level  */
        var closestIndex = 0; 
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    customSpeed = false;
                    DeviceManager.putSetting("cfw_custom_speed", customSpeed);
                    stepBar.step = 3;
                    PrintManager.currentTask.printSpeedMode = stepBar.step;
                }
        ...
        Text {
            ...
            text: speedStr[closestLevel(PrintManager.currentTask.printSpeed)]
            color: "white"
            font.pixelSize: 18
        ...
        Text {
            id: targetSpeedLabel
            text: speedStr[closestLevel(dial.value)]
            color: Colors.brand
            font.pixelSize: 18
